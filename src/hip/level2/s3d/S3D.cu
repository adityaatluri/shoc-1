...
//    printf("\n");
    ...
    // Free host memory
    CUDA_SAFE_CALL(hipFreeHost(host_t));
    CUDA_SAFE_CALL(hipFreeHost(host_p));
    CUDA_SAFE_CALL(hipFreeHost(host_y));
    CUDA_SAFE_CALL(hipFreeHost(host_wdot));
    CUDA_SAFE_CALL(hipFreeHost(host_molwt));
}
